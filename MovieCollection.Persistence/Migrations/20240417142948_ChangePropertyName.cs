    ...
    public partial class ChangePropertyName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "IsFirstLogin",
                table: "AspNetUsers",
                newName: "HasIncompletedInformation");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieUser", x => new { x.MovieCollectionId, x.UsersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_MovieUser_Movies_MovieCollectionId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "HasIncompletedInformation",
                table: "AspNetUsers",
